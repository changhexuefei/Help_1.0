...
public class LoginCommunityAdapter extends RecyclerView.Adapter{
    private Context mContext;
    private ArrayList<MDate> dates = new ArrayList<>();

    public LoginCommunityAdapter(Context mContext) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if(holder instanceof DynamicKindsViewHolder){
            ((DynamicKindsViewHolder) holder).home_pop_tv.setText(loginCommunities.get(position).getCmname());
        }
    }
